...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 14, 2023 at 12:23 PM
...
--
ALTER TABLE `request_form_information`
  MODIFY `req_form_information_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=150;
...
--
-- AUTO INCREMENT for table `tblzone`
--
ALTER TABLE `tblzone`
