                        ...
                        <!-- left column -->
                            <div class="box">
                                ...
                                <form method="post"  enctype="multipart/form-data">
                                    <table id="table_all_resident" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <!-- <?php 
                                                    if(!isset($_SESSION['staff']))
                                            ...
                                            if(!isset($_SESSION['staff']))
                                            {
                                                ...
                                                while($row = mysqli_fetch_array($squery))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width:70px;"><image src="../../pages/resident/image/'.$row['profile_photo'].'" style="width:60px;height:60px;"/></td>
