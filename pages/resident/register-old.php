                ...
                .control-label{
                    ...
                    <div class="row">
                            ...
                            <div class="container-fluid">
                                ...
                                <input type="submit" class="btn btn-primary btn-block btn-sm" name="btn_add" id="btn_add" value="Register Now"/>
                            </div>
                        </div>
            ...
            <div class="panel-body">
              <form role="form" method="post">
                ...
                <div class="form-group">
                  ...
                  <small id="emailHelp" class="form-text" style = "color:white">Already have account? <a href = "login.php" style ="color:#abbad1; text-decoration:underline" > Login here</a></small>
                </div>
                <label id="error" class="label label-danger pull-right"></label> 

                <button type="submit" class="btn btn-sm btn-primary btn-block" name="btn_register">Register now</button>
              </form>
            </div>
          </div>
          </div>
