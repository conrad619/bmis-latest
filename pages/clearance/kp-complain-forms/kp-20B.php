...
<body id="print">
    ...
    <div class="container">
        <span class="fw-bold"> <i>KP FORM # 20-B: CERTIFICATION TO FILE ACTION </i> </span>
            ...
            <div class="statement mx-3">
                <p>
                    <span>
                        ...
                        <br> 1. There was a personal confrontation between the parties before the Punong Barangay but mediation failed;
                        <br> 2. The Punong Barangay set the meeting of the parties for the constitution of the Pangkat;
                        <br> 3. The respondent willfully failed or refused to appear without justifiable reason at the conciliation proceedings before the Pangkat; and
                        <br> 4. Therefore, the corresponding complaint for the dispute may now be filed in court/government office.
                    </span>
                <p>
                    <span class="ms-5">
                        This <span> <?php
