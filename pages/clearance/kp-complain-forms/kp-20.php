...
<body id="print">
    ...
    <div class="container">
        <span class="fw-bold"> <i>KP FORM # 20: CERTIFICATION TO FILE ACTION (FROM LUPON SECRETARY)</i> </span>
            ...
            <div class="statement mx-3">
                <p>
                    <span>
                        ...
                        <br> 1. There has been a personal confrontation between the parties before the Punong Barangay/Pangkat ng Tagapagkasundo;
                        <br> 2. A settlement was reached;
                        <br> 3. The settlement has been repudiated in a statement sworn to before the Punong Barangay by ______________ on ground of ______________; and
