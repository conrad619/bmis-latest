...
<head>
    ...
    /* body{
      ...
      background: -moz-linear-gradient(0deg, rgba(0,252,255,0.9472163865546218) 0%, rgba(54,255,31,0.9920343137254902) 100%);
      background: -webkit-linear-gradient(0deg, rgba(0,252,255,0.9472163865546218) 0%, rgba(54,255,31,0.9920343137254902) 100%);
      background: linear-gradient(0deg, rgba(0,252,255,0.9472163865546218) 0%, rgba(54,255,31,0.9920343137254902) 100%);
      filter: progid:DXImageTransform.Microsoft.gradient(startColorstr="#00fcff",endColorstr="#36ff1f",GradientType=1);  
    } */
    </style>
</head>
<body>
